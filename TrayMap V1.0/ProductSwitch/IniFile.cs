...
namespace IN3Automation.Utility
    {
    /// <summary>
    /// ini文件类
    /// </summary>
    public class IniFile
        ...
        public int ReadInt(string section, string name, int def)
            {
            return GetPrivateProfileInt(section, name, def, this._FileName);
            }
        ...
        public string ReadString(string section, string name, string def)
            ...
            GetPrivateProfileString(section, name, def, vRetSb, 2048, this._FileName);
        ...
        public void WriteInt(string section, string name, int Ival)
            ...
            WritePrivateProfileString(section, name, Ival.ToString(), this._FileName);
            }
        ...
        public void WriteString(string section, string name, string strVal)
            {
            WritePrivateProfileString(section, name, strVal, this._FileName);
            }
        ...
        public void DeleteSection(string section)
            {
            WritePrivateProfileString(section, null, null, this._FileName);
            }
        ...
        public string IniReadValue(string section, string name)
            ...
            GetPrivateProfileString(section, name, "", strSb, 256, this._FileName);
        ...
        public void IniWriteValue(string section, string name, string value)
            {
            WritePrivateProfileString(section, name, value, this._FileName);
            }
        }
    }
